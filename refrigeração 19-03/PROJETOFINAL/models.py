...
class DadoCLP(Base):
    ...
    vel_motor = Column(Text)
    corrente_r_comp = Column(Float)
    corrente_s_comp = Column(Float)
    corrente_t_comp = Column(Float)
    pot_a_total_comp = Column(Float)
    fat_pot_comp = Column(Float)
    ...
    def get_DadosDB(self):
        ...
        self.vel_motor,
        self.corrente_r_comp,
        self.corrente_s_comp,
        self.corrente_t_comp,
        self.pot_a_total_comp,
        self.fat_pot_comp
    ]