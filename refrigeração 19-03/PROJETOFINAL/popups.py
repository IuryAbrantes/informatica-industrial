...
class MedidoresMotorPopup(Popup):
    """
    Popup para monitoramento de medidores do motor
    """

class MedidoresCompPopup(Popup):
    """
    Popup para monitoramento de medidores do compressor
    """

class ComandoCompPopup(Popup):
    """
    Popup para configurações dos compressores
    """
...
class GraficoVelArPopup(Popup):
    """
    Popup para monitoramento gráfico da velocidade de saída de ar da planta
    """
    def __init__(self,xmax, plot_color, **kwargs):
        super().__init__(**kwargs)
        self._plot = LinePlot(line_width=1.5, color=plot_color)
...
class GraficoVelMPopup(Popup):
    """
    Popup para monitoramento gráfico da velocidade do ventilador da planta
    """
    def __init__(self,xmax, plot_color, **kwargs):
        super().__init__(**kwargs)
        self._plot = LinePlot(line_width=1.5, color=plot_color)
...
class LabelCheckBoxGraficosVelAr(BoxLayout):
    """
    
    """

class LabelCheckBoxGraficosVelM(BoxLayout):
    """
