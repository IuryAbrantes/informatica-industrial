    ...
    def build(self):
        ...
        self._widget = MainWidget(scan_time = 1000, 
                                  ...
                                  modbus_addrs = {
                                    ...
                                    'corrente_r':{'addr': 840, 'modelo': 'holding', 'divisor': 10},
                                    'corrente_s':{'addr': 841, 'modelo': 'holding', 'divisor': 10},
                                    'corrente_t':{'addr': 842, 'modelo': 'holding', 'divisor': 10},
                                    'corrente_r_comp':{'addr': 726, 'modelo': 'holding', 'divisor': 10},
                                    'corrente_s_comp':{'addr': 727, 'modelo': 'holding', 'divisor': 10},
                                    'corrente_t_comp':{'addr': 728, 'modelo': 'holding', 'divisor': 10},
                                    'pot_a_total_comp':{'addr': 738, 'modelo': 'holding', 'divisor': 1},
                                    'pot_a_total':{'addr': 855, 'modelo': 'holding', 'divisor': 1},
                                    'fat_pot':{'addr' : 871, 'modelo' : 'holding', 'divisor': 1000},
                                    'fat_pot_comp':{'addr' : 750, 'modelo' : 'holding', 'divisor': 1000},
                                    ...
                                    'vel_motor': {'addr': 884, 'modelo': 'float', 'divisor': 1}})
