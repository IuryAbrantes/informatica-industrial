...
from popups import ModbusPopup, ScanPopup, MedidoresPopup, GraficoMotorPopup, MotoresPopup, DadosPopup, OutrosPopup, GraficoArSaiPopup, GraficoTit01Popup, GraficoTit02Popup
