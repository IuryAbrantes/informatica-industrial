...
class MainWidget(BoxLayout):
        ...
        def __init__(self, **kwargs):
                ...
                self._graficosPopup = GraficosPopup(self._max_points,self._tags['temperatura_carcaca']['color'])
        ...
        def leituraFloat(self, addr):
                ...
                #print(str(decodificador.decode_32bit_float()))
        ...
        def updateGUI(self):
                ...
                #Atualizar gráfico
                self._graficosPopup.ids.graph.updateGraph((self._meas['timestamp'],self._meas['values']['temperatura_carcaca']),0)
