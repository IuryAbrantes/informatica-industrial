...
class MainWidget(BoxLayout):
        ...
        def updateGUI(self):
                ...
                self.ids.lb_tempcarc.size = (self.ids.lb_tempcarc.size[0],self._meas['values']['temperatura_carcaca']/120*self.ids.termometro.size[1])
                print(self._meas['values']['temperatura_carcaca'])
        ...
        def BuscaComKivy(self):
                ...
                try:
                        ...
                        final_t = self.parseDTString(self._hgraph.ids.txt_init_time.text)
                        cols = []
                        for sensor in self._hgraph.ids.sensores